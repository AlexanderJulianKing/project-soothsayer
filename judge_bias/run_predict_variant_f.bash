...
run "F1_baseline_eq_swap"      "benchmark_combiner/benchmarks/clean_combined_all_benches_variantF1.csv"
run "F2_baseline_eq_parallel"  "benchmark_combiner/benchmarks/clean_combined_all_benches_variantF2.csv"
run "F3_sem_eq_swap"           "benchmark_combiner/benchmarks/clean_combined_all_benches_with_sem_v4_d32_variantF3.csv"
run "F4_sem_eq_parallel"       "benchmark_combiner/benchmarks/clean_combined_all_benches_with_sem_v4_d32_variantF4.csv"

echo
echo "=============== VARIANT F COMPLETE ==============="
