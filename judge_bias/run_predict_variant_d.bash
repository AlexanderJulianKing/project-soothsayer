...
run "D_baseline_variantD"       "benchmark_combiner/benchmarks/clean_combined_all_benches_variantD.csv"
run "D_sem_champion_variantD"   "benchmark_combiner/benchmarks/clean_combined_all_benches_with_sem_v4_d32_variantD.csv"

echo
echo "=============== VARIANT D COMPLETE ==============="
